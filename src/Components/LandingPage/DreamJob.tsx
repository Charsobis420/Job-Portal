    ...
    return (
        <div className="flex sm-mx:flex-col-reverse items-center px-16 bs-mx:px-10 md-mx:px-5">
            <div className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-gold-400">Find your <span>dream</span> <span>job</span> with us</div>
                ...
                <div className="flex gap-3 mt-5 items-center">
                    ...
                    <div className="flex items-center justify-center h-full w-20 bg-gold-400 text-mine-shaft-100 rounded-lg p-2 hover:bg-gold-500 cursor-pointer">
