...
const Working = () => {
    return <div className="mt-20 pb-5">
        <div className="text-4xl md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-3 text-mine-shaft-100">How it <span className="text-gold-400">Works</span></div>
        <div className="text-lg mb-10 sm-mx:text-base xs-mx:text-sm mx-auto text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12">Effortlessly navigate through the process and land your dream jobs.</div>
        <div className="flex px-16 bs-mx:px-10 gap-2 md-mx:flex-col md-mx:px-5 justify-between items-center">
            <div className="relative">
                ...
                <div className="w-36 xs-mx:w-28 flex top-[15%] right-0 absolute flex-col items-center gap-1 border border-gold-400 rounded-xl py-3 px-1 backdrop-blur-md">
            ...
            <div className="flex flex-col gap-10">
                {
                    ...
                    <div className="p-2.5 bg-gold-300 rounded-full">
